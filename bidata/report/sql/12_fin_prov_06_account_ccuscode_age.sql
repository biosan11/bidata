...
-- 输出数据
truncate table report.fin_prov_06_account_ccuscode_age;
insert into report.fin_prov_06_account_ccuscode_age 
select 
    a.db
    ,a.cdwcode
...
from report.fin_prov_06_account_ccuscode_age 
...
truncate table report.fin_prov_07_account_ccuscode_age_6mon;
insert into report.fin_prov_07_account_ccuscode_age_6mon
select 
    b.bi_cusname
    ,null
    ,a.balance_closing
