...
-- 健康检测 启代
update pdm.invoice_order set if_xs = '非销售_健康检测' where item_code = 'JK0101';
...
update pdm.invoice_order set if_xs='非销售_销管代理商确认' where if_xs is null and db = 'UFDATA_222_2019'and csbvcode = '06795940';
