...
# 参数入口
start1_dt = sys.argv[1]

#常量
SQL_FILE = '/home/bidata/edw/sql/crm_bid_informations.sql'
LOG_FILE = '/home/bidata/edw/log/crm_bid_informations.log'
