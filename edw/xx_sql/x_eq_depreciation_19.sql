...
drop table if exists edw.x_eq_depreciation_19_pre;
create temporary table edw.x_eq_depreciation_19_pre as
select a.cohr
      ,a.year_belong
      ,a.vouchid
      ,a.ddate_belong
      ...
      ,a.amount_depre_11
      ,a.amount_depre_12
  from ufdata.x_eq_depreciation_19 a
...
update edw.x_eq_depreciation_19_pre a
...
select a.cohr
      ...
      ,a.amount_depre_11
      ,a.amount_depre_12
  from edw.x_eq_depreciation_19_pre a
  left join (select * from edw.dic_customer group by ccusname) b
    on a.ccusname = b.ccusname
  left join (select * from edw.dic_inventory group by cinvname) c
    on a.eq_name = c.cinvname
