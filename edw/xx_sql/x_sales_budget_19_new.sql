...
create table if not exists edw.x_sales_budget_19_new(
	...
	bi_cinvcode varchar(60) comment '存货编码',
	bi_cinvname varchar(255) comment '存货名称',
	...
	key _x_sales_budget_19_new_bi_cinvcode (bi_cinvcode)
...
drop table if exists ufdata.x_sales_budget_19_new_pre;
create temporary table ufdata.x_sales_budget_19_new_pre as
select a.*,c.bi_cinvcode,c.bi_cinvname
  from ufdata.x_sales_budget_19_new a
...
select 
	...
	,iunitcost
	,isum_budget_1901
from ufdata.x_sales_budget_19_new_pre;
