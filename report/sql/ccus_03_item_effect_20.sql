...
--功能：项目对应的成效分析
------------------------------------------------------------------------------------------
--程序名称：ccus_03_item_effect_20.sql
--目标模型：invoice_order
--源    表：pdm.invoice_order,edw.x_eq_depreciation_20_relation,edw.x_cinv_relation
-----------------------------------------------------------------------------------------
--加载周期：日增
------------------------------------------------------------------------------------------
 --作者：jiangsh
...
-- 创建合集，这里是项目合集
drop table if exists report.mid00_ccus_03_item_effect_20;
create temporary table report.mid00_ccus_03_item_effect_20 as
select a.ccuscode
...
CREATE INDEX index_mid00_ccus_03_item_effect_20_cinvcode ON report.mid00_ccus_03_item_effect_20(cinvcode);
CREATE INDEX index_mid00_ccus_03_item_effect_20_ccuscode ON report.mid00_ccus_03_item_effect_20(ccuscode);

-- 这里是主试剂合集
drop table if exists report.mid0_ccus_03_item_effect_20;
create temporary table report.mid0_ccus_03_item_effect_20 as
select a.ccuscode
      ,b.cinvcode
      ,b.cinvname
      ,b.cinvcode_main
...
CREATE INDEX index_mid0_ccus_03_item_effect_20_cinvcode ON report.mid0_ccus_03_item_effect_20(cinvcode);
CREATE INDEX index_mid0_ccus_03_item_effect_20_ccuscode ON report.mid0_ccus_03_item_effect_20(ccuscode);

-- 主试剂对应的收入汇总
drop table if exists report.mid1_ccus_03_item_effect_20;
create temporary table report.mid1_ccus_03_item_effect_20 as
 select a.ccuscode
       ,a.cinvcode
       ,a.cinvname
       ,a.cinvcode_main
   ...
   from report.mid0_ccus_03_item_effect_20 a
...
CREATE INDEX index_mid1_ccus_03_item_effect_20_cinvcode ON report.mid1_ccus_03_item_effect_20(cinvcode);
CREATE INDEX index_mid1_ccus_03_item_effect_20_ccuscode ON report.mid1_ccus_03_item_effect_20(ccuscode);

-- 这里是辅助试剂合集
drop table if exists report.mid2_ccus_03_item_effect_20;
create temporary table report.mid2_ccus_03_item_effect_20 as
...
CREATE INDEX index_mid2_ccus_03_item_effect_20_cinvcode ON report.mid2_ccus_03_item_effect_20(cinvcode);
CREATE INDEX index_mid2_ccus_03_item_effect_20_ccuscode ON report.mid2_ccus_03_item_effect_20(ccuscode);

-- 辅助试剂分配的试剂大于1的情况下进行拆分,辅助试剂耗材
-- 这里计算辅助试剂各个客户的汇总
drop table if exists report.mid3_ccus_03_item_effect_20;
create temporary table report.mid3_ccus_03_item_effect_20 as
select a.province
      ,a.city
      ,a.ccuscode
      ,a.ccusname
  ...
  from report.mid2_ccus_03_item_effect_20 a
  left join (select *,sum(isum) as isum_1,sum(cost) as cost1,sum(invoice_amount) as invoice_amount_1 from report.mid1_ccus_03_item_effect_20 group by cinvcode_main,ccuscode) b
...
-- 主试剂成本,下面移动上来的
drop table if exists report.mid8_ccus_03_item_effect_20;
create temporary table report.mid8_ccus_03_item_effect_20 as
select a.ccuscode
      ,a.cinvcode_main as cinvcode
      ,sum(b.cost) as isum
  from report.mid1_ccus_03_item_effect_20 a
  left join report.fin_11_sales_cost_base b
    on a.ccuscode = b.ccuscode
   and a.cinvcode = b.cinvcode
 where year(b.ddate) = '2020'
...
-- 删除没有主试剂成本的数据
drop table if exists report.mid31_ccus_03_item_effect_20;
create temporary table report.mid31_ccus_03_item_effect_20 as
select a.*
  from report.mid3_ccus_03_item_effect_20 a
  left join (select * from report.mid8_ccus_03_item_effect_20 where isum <> 0) b
...
-- 相关的主试剂汇总
drop table if exists report.mid4_ccus_03_item_effect_20;
create temporary table report.mid4_ccus_03_item_effect_20 as
select a.province
      ,a.city
      ,a.ccuscode
      ,a.ccusname
  ...
  from report.mid31_ccus_03_item_effect_20 a
  group by cinvcode,ccuscode
;

CREATE INDEX index_mid31_ccus_03_item_effect_20_cinvcode ON report.mid31_ccus_03_item_effect_20(cinvcode);
CREATE INDEX index_mid31_ccus_03_item_effect_20_ccuscode ON report.mid31_ccus_03_item_effect_20(ccuscode);

CREATE INDEX index_mid4_ccus_03_item_effect_20_cinvcode ON report.mid4_ccus_03_item_effect_20(cinvcode);
CREATE INDEX index_mid4_ccus_03_item_effect_20_ccuscode ON report.mid4_ccus_03_item_effect_20(ccuscode);

-- 计算每家客户辅助试剂比例
drop table if exists report.mid5_ccus_03_item_effect_20;
create temporary table report.mid5_ccus_03_item_effect_20 as
select a.province
      ,a.city
      ,a.ccuscode
      ,a.ccusname
  ...
  from report.mid31_ccus_03_item_effect_20 a
  left join report.mid4_ccus_03_item_effect_20 b
    on a.cinvcode = b.cinvcode
   and a.ccuscode = b.ccuscode
;

CREATE INDEX index_mid5_ccus_03_item_effect_20_cinvcode ON report.mid5_ccus_03_item_effect_20(cinvcode);
CREATE INDEX index_mid5_ccus_03_item_effect_20_ccuscode ON report.mid5_ccus_03_item_effect_20(ccuscode);

-- 得到20年所有辅助试剂已经分配完的金额
drop table if exists report.mid6_ccus_03_item_effect_20;
create temporary table report.mid6_ccus_03_item_effect_20 as
select b.province
      ,b.city
      ,b.ccuscode
      ,b.ccusname
  ...
  left join report.mid5_ccus_03_item_effect_20 b
    on a.cinvcode = b.cinvcode
...
-- 主辅试剂合并到一起
drop table if exists report.mid7_ccus_03_item_effect_20;
create temporary table report.mid7_ccus_03_item_effect_20 as
select a.province
      ,a.city
      ,a.ccuscode
      ,a.ccusname
  ...
  from (select *,sum(isum) as isum_1,sum(invoice_amount) as invoice_amount_1 from report.mid1_ccus_03_item_effect_20 group by cinvcode_main,ccuscode) a
--  left join report.mid2_ccus_03_item_effect_20 b
--    on a.cinvcode = b.cinvcode_main
--   and a.ccuscode = b.ccuscode
  left join report.mid6_ccus_03_item_effect_20 c
...
-- 辅助试剂成本
drop table if exists report.mid9_ccus_03_item_effect_20;
create temporary table report.mid9_ccus_03_item_effect_20 as
select b.ccuscode
      ,b.cinvcode
      ,b.cinvcode_main
...
drop table if exists report.mid10_ccus_03_item_effect_20;
create temporary table report.mid10_ccus_03_item_effect_20 as
select cinvcode,ccuscode from report.mid8_ccus_03_item_effect_20 union
select cinvcode_main,ccuscode from report.mid9_ccus_03_item_effect_20
;

-- 成本主辅合并到一起
drop table if exists report.mid11_ccus_03_item_effect_20;
create temporary table report.mid11_ccus_03_item_effect_20 as
select a.ccuscode
      ,a.cinvcode
      ,b.isum as isum_main
      ,c.isum as isum_child
  from report.mid10_ccus_03_item_effect_20 a
  left join report.mid8_ccus_03_item_effect_20 b
    on a.cinvcode = b.cinvcode
   and a.ccuscode = b.ccuscode
  left join report.mid9_ccus_03_item_effect_20 c
...
-- 数据汇总
truncate table report.ccus_03_item_effect_20;
insert into report.ccus_03_item_effect_20
select a.province
      ,a.city
      ,null
      ,null
      ...
      ,ifnull(c.amount_20,0) as amount_20
      ,0 as sy_md
      ,ifnull(f.isum,0) as insure_md
      ,d.install_dt
      ,0
      ,0
  from report.mid00_ccus_03_item_effect_20 a
  left join report.mid11_ccus_03_item_effect_20 b
    on a.cinvcode = b.cinvcode
   and a.ccuscode = b.ccuscode
  left join (select bi_cuscode,bi_cinvcode,sum(amount_19) as amount_20 from edw.x_eq_depreciation_19_relation group by bi_cuscode,bi_cinvcode) c
  ...
  left join report.mid7_ccus_03_item_effect_20 e
...
-- 删除所有数值为0的数据
delete from report.ccus_03_item_effect_20 
 where isum_main < 0.1 
   and isum_child < 0.1 
...
drop table if exists report.mid12_ccus_03_item_effect_20;
create temporary table report.mid12_ccus_03_item_effect_20 as
select a.finnal_ccuscode as ccuscode
      ,a.cinvcode
      ,a.iunitcost_main
  from report.ccus_03_item_effect_20 a
...
;
-- 项目客户聚合
drop table if exists report.mid13_ccus_03_item_effect_20;
create temporary table report.mid13_ccus_03_item_effect_20 as
select a.ccuscode
      ,a.cinvcode
      ,sum(a.iunitcost_main) as iunitcost_main
  from report.mid12_ccus_03_item_effect_20 a
 group by a.ccuscode
;

drop table if exists report.mid14_ccus_03_item_effect_20;
create temporary table report.mid14_ccus_03_item_effect_20 as
select a.ccuscode
      ,a.cinvcode
      ,c.isum * a.iunitcost_main / b.iunitcost_main as sy_md
  from report.mid12_ccus_03_item_effect_20 a
  left join report.mid13_ccus_03_item_effect_20 b
    on a.ccuscode = b.ccuscode
--   and a.cinvcode = b.cinvcode
  left join (select bi_cuscode,sum(isum) as isum from edw.x_account_sy where left(y_mon,4) = '2020' group by bi_cuscode)  c
    on a.ccuscode = c.bi_cuscode
;

update report.ccus_03_item_effect_20 a
 inner join report.mid14_ccus_03_item_effect_20 b
    on a.cinvcode = b.cinvcode
   and a.finnal_ccuscode = b.ccuscode
...
-- 定义的LDT、服务类项目
drop table if exists report.mid15_ccus_03_item_effect_20;
create temporary table report.mid15_ccus_03_item_effect_20 as
...
select a.province
      ...
      ,0
  from report.invoice_order_pre a
  left join report.mid15_ccus_03_item_effect_20 b
...
update report.ccus_03_item_effect_20 set profit = (invoice_amount_main + invoice_amount_child - iunitcost_main - iunitcost_child -amount_20 - insure_md) where cinvname <> 'BGISEQ-500';
update report.ccus_03_item_effect_20 set profit = (invoice_amount_main + invoice_amount_child - iunitcost_main - iunitcost_child -amount_20) where cinvname = 'BGISEQ-500';

-- 更新项目利润率
update report.ccus_03_item_effect_20 set profit_margin = ifnull(profit / (ifnull(invoice_amount_main,0) + ifnull(invoice_amount_child,0)),0);

-- 更新最终客户对应的客户情况
update report.ccus_03_item_effect_20 a
inner join (select * from pdm.invoice_price where state = '最后一次价格' and left(ccuscode,2) = 'DL' and end_dt >= '2020-01-01' group by finnal_ccuscode) b
    on a.finnal_ccuscode = b.finnal_ccuscode
   set a.ccuscode = b.ccuscode
      ,a.ccusname = b.ccusname
;

update report.ccus_03_item_effect_20 set ccuscode = finnal_ccuscode,ccusname = finnal_ccusname where ccuscode is null;
