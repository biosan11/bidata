...
select 
    ...
    case 
        ...
        when name_ehr_id2 = "A待定销售一部" then "fy_salesdept" -- A待定 到销售一部
        when name_ehr_id2 = "A待定销售二部" then "fy_salesdept" -- A待定 到销售二部
    ...
    case 
        ...
        when name_ehr_id2 = "A待定销售一部" then "销售一部" -- A待定 到销售一部
        when name_ehr_id2 = "A待定销售二部" then "销售二部" -- A待定 到销售二部
