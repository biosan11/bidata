...
truncate table report.cost_01_account_fy_ccus;
insert into report.cost_01_account_fy_ccus
...
update report.cost_01_account_fy_ccus set d_num = 0 where d_num > 1;
update report.cost_01_account_fy_ccus set diff_dt = 1 where d_num = 0;
