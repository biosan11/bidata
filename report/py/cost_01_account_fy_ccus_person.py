...
# start_dt = sys.argv[1]
# 获取当天
start_dt = time.strftime("%Y-%m-%d", time.localtime())

#常量
SQL_FILE = '/home/bidata/report/sql/cost_01_account_fy_ccus_person.sql'
LOG_FILE = '/home/bidata/report/log/cost_01_account_fy_ccus_person.log'
