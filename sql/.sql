...
-- 导入正式表 用于计算试剂业务考核分
drop table if exists bidata.ft_18_personscore_sales;
create table if not exists bidata.ft_18_personscore_sales
select 
    a.year_
    ,a.person_name
    ,a.month_
    ...
    ,b.position_name
    ,b.position_name_main
    ,c.position_name_ad
    ,b.jobpost_name
    ,b.employeestatus
    ,b.lastworkdate
from bidata.bonus_tem01 as a 
left join (select name,position_name,position_name_main,jobpost_name,employeestatus,lastworkdate from bidata.dt_15_person_ehr group by name) as b
